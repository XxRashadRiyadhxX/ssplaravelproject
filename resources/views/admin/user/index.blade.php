                                        ...
                                        <td
                                            ...
                                            <div class="flex gap-3">
                                                <a href="{{ route('user.edit', $user->id) }}"
                                                    class="rounded bg-gray-900 px-2 py-1 text-xs font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-800">Edit</a>
                                                <form
                                                    action="{{ route('user.destroy', $user->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="rounded bg-gray-900 px-2 py-1 text-xs font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-800">Delete</button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
